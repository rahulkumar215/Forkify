...
const recipeView = async function() {
    try {
        const data = await AJAX("https://forkify-api.herokuapp.com/api/v2/recipes/5ed6604591c37cdc054bc886");
    ...
    const markup = `
        ...
        <div class="recipe__ingredients">
          ...
          <ul class="recipe__ingredient-list">
            ${recipe.ingredients.forEach((ingredient)=>renderIngredients(ingredient))}
          </ul>
        </div>
